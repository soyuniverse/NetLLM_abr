### g_repeat_k3_f5_pred — per-decision post-hoc analysis

`results/soyun/serve_gate_20260909/g_repeat_k3_f5_pred/decisions.jsonl` — 4700 decisions over 100 traces; 2027 draft+verify steps, 2921 steps where the LLM actually produced an action.
...
|---|---|---|---|---|---|---|
| draft_verify | 2027 | 43.13 % | 84.013 | 0.209 | 1.061 | 148.787 |
| fallback | 894 | 19.02 % | 77.527 | n/a | n/a | 147.949 |
| queue_serve | 1779 | 37.85 % | 1.862 | n/a | n/a | 0.000 |

전체 decision latency 합 242916 ms 중 MPC brute-force rollout CPU 시간은 423 ms (**0.17 %**), throughput predictor까지 포함해도 0.36 %.
