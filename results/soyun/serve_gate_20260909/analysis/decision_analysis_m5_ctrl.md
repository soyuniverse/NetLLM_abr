### m5_ctrl — per-decision post-hoc analysis

`results/soyun/serve_gate_20260909/m5_ctrl/decisions.jsonl` — 4700 decisions over 100 traces; 1762 draft+verify steps, 2733 steps where the LLM actually produced an action.
...
|---|---|---|---|---|---|---|
| draft_verify | 1762 | 37.49 % | 95.053 | 0.684 | 1.677 | 162.016 |
| fallback | 971 | 20.66 % | 79.442 | n/a | n/a | 149.039 |
| queue_serve | 1967 | 41.85 % | 1.819 | n/a | n/a | 0.000 |

전체 decision latency 합 248200 ms 중 MPC brute-force rollout CPU 시간은 1205 ms (**0.49 %**), throughput predictor까지 포함해도 0.67 %.
