### m1b_mpc_k3_greedy — per-decision post-hoc analysis

`results/soyun/drafter_ab_20260908/m1b_mpc_k3_greedy/decisions.jsonl` — 4700 decisions over 100 traces; 4137 draft+verify steps, 4405 steps where the LLM actually produced an action.
...
|---|---|---|---|---|---|---|
| draft_verify | 4137 | 88.02 % | 89.394 | 0.337 | 0.065 | 148.662 |
| fallback | 268 | 5.70 % | 86.387 | n/a | n/a | 139.060 |
| queue_serve | 295 | 6.28 % | 1.798 | n/a | n/a | 0.000 |

전체 decision latency 합 393503 ms 중 MPC brute-force rollout CPU 시간은 1396 ms (**0.35 %**), throughput predictor까지 포함해도 0.47 %.
