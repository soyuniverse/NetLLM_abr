### m5_hybrid_k5 — per-decision post-hoc analysis

`results/soyun/drafter_ab_20260908/m5_hybrid_k5/decisions.jsonl` — 4700 decisions over 100 traces; 1762 draft+verify steps, 2733 steps where the LLM actually produced an action.
...
|---|---|---|---|---|---|---|
| draft_verify | 1762 | 37.49 % | 109.179 | 0.666 | 1.641 | 162.016 |
| fallback | 971 | 20.66 % | 91.804 | n/a | n/a | 149.039 |
| queue_serve | 1967 | 41.85 % | 1.778 | n/a | n/a | 0.000 |

전체 decision latency 합 285010 ms 중 MPC brute-force rollout CPU 시간은 1173 ms (**0.41 %**), throughput predictor까지 포함해도 0.57 %.
