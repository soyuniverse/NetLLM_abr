### m3_hybrid_k3 — per-decision post-hoc analysis

`results/soyun/drafter_ab_20260908/m3_hybrid_k3/decisions.jsonl` — 4700 decisions over 100 traces; 2101 draft+verify steps, 2948 steps where the LLM actually produced an action.
...
|---|---|---|---|---|---|---|
| draft_verify | 2101 | 44.70 % | 90.459 | 0.239 | 1.094 | 146.521 |
| fallback | 847 | 18.02 % | 87.597 | n/a | n/a | 148.979 |
| queue_serve | 1752 | 37.28 % | 1.807 | n/a | n/a | 0.000 |

전체 decision latency 합 267415 ms 중 MPC brute-force rollout CPU 시간은 503 ms (**0.19 %**), throughput predictor까지 포함해도 0.36 %.
